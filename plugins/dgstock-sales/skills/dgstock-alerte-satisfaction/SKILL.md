...
Trie par ancienneté (`created_at` croissant) : la réclamation la plus vieille est la priorité n°1, pas la plus récente. Sur ce type de compte, une réclamation peut rester ouverte plusieurs mois sans réponse — un délai aussi long est en soi l'alerte, indépendamment du contenu.
